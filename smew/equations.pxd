...
cdef double water_residual(double H_rain, double Alk_rain, double k1,
                           double k2, double CO2_w_rain, double k_w) noexcept nogil
cdef double h_residual(double H0, double k1, double k2,
                       double CO2_w0, double k_w, double Alk0) noexcept nogil
...
cdef int biogeochem_residual(const double *p, double Alk_tot, double n,
        ...
        double K_Ca_H, double *out) noexcept nogil
...
cdef int total_to_cec_residual(const double *p, double H, double n,
        ...
        double K_Ca_K, double K_Ca_H, double *out) noexcept nogil

@cython.locals(Al_tot=cython.double, CaCO3=cython.double,
               f_Al=cython.double, f_H=cython.double, f_Ca=cython.double)
cdef int kelland_residual(const double *p, double Al_w, double Al,
